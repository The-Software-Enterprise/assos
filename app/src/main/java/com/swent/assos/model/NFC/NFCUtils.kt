...
@RequiresApi(Build.VERSION_CODES.TIRAMISU)
fun resolveWritingIntent(intent: Intent, ticketList: MutableStateFlow<List<String>>, context: Context): Boolean {
...
@RequiresApi(Build.VERSION_CODES.TIRAMISU)
fun resolveReadingIntent(intent: Intent, validIDs: MutableStateFlow<MutableList<String>>, ticketId: String, context: Context) {
    val validActions =
        listOf(
            NfcAdapter.ACTION_TAG_DISCOVERED,
            NfcAdapter.ACTION_TECH_DISCOVERED,
